...
<header>
	...
	<form method='POST' action='ControlerTransp'>
	<div class="spec">
		<article class="btn1">
	...
	<div class="center">
		...
		<table>
			...
			<tr>
				<th class="border">Environnement de la logistique</th>
			...
			<tr>
				<th class="border">Supply chain management</th>
			...
			<tr>
				<th class="border">Logistique amont/aval</th>
