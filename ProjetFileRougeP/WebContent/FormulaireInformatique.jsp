...
<header>
	...
	<form method='POST' action='ControlerInfo'>
	<div class="spec">
		<article class="btn1">
	...
	<div class="center">
		...
		<table>
			...
			<tr>
				<th class="border">Intelligence artificielle</th>
			...
			<tr>
				<th class="border">Réseautique</th>
			...
			<tr>
				<th class="border">Informatique industrielle</th>
			...
			<tr>
				<th class="border">Architecture de l'ordinateur</th>
